...
async function fetchPlausibleData() {
    try {
        const response = await fetch('https://cryptic-headland-94862.herokuapp.com/orngevkmucghqisxqeas.supabase.co/functions/v1/papi-service', { // Replace with your function URL
